...
| **Estimated customer touchpoints** | All HubSpot contacts, forms, booking links               |
...
| ----- | ----- | ------ | ----------- | ----- |
| 1 | Discovery & scope | completed | Apr 2026 | Nurture + onboarding pivot; Romina ownership |
| 2 | Build & execute | wip | | Contacts upload (B7) · pipeline (B1) · LP (A5) · holiday send (A3 done) |
| 3 | Measure & optimize | wip | | Source hygiene + A8 HubSpot channel row |
