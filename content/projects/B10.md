# B10 — Social & Directory Profile Refresh & Tracking
...
| **Estimated customer touchpoints** | GBP, Directory profiles, Social bios                       |
...
| ----- | ----- | ------ | ----------- | ----- |
| 1 | Discovery & scope | completed |  | (None — discovery starts on kickoff) |
| 2 | Build & execute | wip |  | LinkedIn company showcase exists but shows low foll…; Andrew + Casey personal LinkedIn and directory prof… (+3 more) |
| 3 | Measure & optimize | wip |  | UTM naming scheme partially drafted for contact URLs (+1 more) |
