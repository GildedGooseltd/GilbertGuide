...
window.PROJECT_DATA = {
  ...
  "recommendedPackage": {
    "label": "Recommended package (P1 B2 · P5 B1 · P9 B4 · P10 A4 · P3 A2 + Retainer)",
    "retainer": true,
    "projectIds": [
      "B2",
      "B1",
