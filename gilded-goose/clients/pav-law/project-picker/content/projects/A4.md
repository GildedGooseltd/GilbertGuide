...
| **Estimated customer touchpoints** | HubSpot email, Past-client lists, Past clients, Referral ask workflows |
...
| ----- | ----- | ------ | ----------- | ----- |
| 1 | Discovery & scope | completed |  | Missed-call follow-up text templates; Client update email positioning drafts |
| 2 | Build & execute | wip |  | Traffic intake script for Romina |
| 3 | Measure & optimize | wip |  | Period: Program to date through Jul 14, 2026 (+7 more) |
