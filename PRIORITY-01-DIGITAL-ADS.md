# Priority 1 · Digital Ads Expansion

Andrew top priority. Parent index: [HUBSPOT-PROJECTS-REVIEW.md](HUBSPOT-PROJECTS-REVIEW.md).  
Channel brainstorm: [PRIORITY-01-ADS-CHANNEL-BRAINSTORM.md](PRIORITY-01-ADS-CHANNEL-BRAINSTORM.md).

Last updated: 09/17/2026

## Goal

Grow and diversify paid channels. Google Ads, LSA, and ongoing NTGUILT Search stay under the monthly Digital Ads Maintenance Retainer. That retainer is Required maintenance, not a Priority 1 add-on row below.

Good timing while the team is away: new channels need a few weeks to learn. Set them up in October so November and December can recover volume after the thin-cover lag. Holiday DUI Search creatives and other seasonal Search expansions can build in the same window.
...
| [Yelp Ads](content/projects/Yelpv1.md) | Page and ads already tested on a low budget with solid results. Next: team message response + HubSpot number to Gabriel, expand review nurture, owner replies and listing content, insurance-card Yelp insert for Casey / Jack / Andrew. | $2,600 setup + $500/mo · Oct start · max end +2 months · max 5 equal biweekly payments · no deposit % · media separate |
...
## Deferred · push back on priority

| Project | Notes |
| ------- | ----- |
| [Adult Site Ad Campaign](content/projects/AdultAds.md) | Mature-interest research stays on the unpublished AdultAds plan. Off the Priority 1 sell list and Guide dash until a tighter buyable-site shortlist is ready. Fee placeholder $2,400 · media separate. |
...
- Microsoft Ads, radio, TV, and PPIR are tested and failed. Keep them off the marketing mix.
- Full channel brainstorm and buyable shortlist: [PRIORITY-01-ADS-CHANNEL-BRAINSTORM.md](PRIORITY-01-ADS-CHANNEL-BRAINSTORM.md).
