...
Each KPI / chart card shows **👍**, **👎**, and a **Comment** box. Votes and notes save in the **browser** and ship via **Download Feedback Report** / **Email Kate**.
...
4. When done: **Download Feedback Report** or **Email Kate**.
